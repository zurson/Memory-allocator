...
# Znacznik czasowy: 2022-12-11 14:00:11.496189
#

OUTDIR		:= build-dir

CC          := gcc
CC_FLAGS    := -Werror -xc -Wno-error=parentheses -Wno-error=implicit-fallthrough -Wall -D_ANSI_OUTPUT -ggdb3 -std=c11 -Werror=vla -fmax-errors=5 -DINSIDE_DANTE -Wextra -Wno-parentheses -fdiagnostics-color -D_GNU_SOURCE -Wno-error=unused-parameter -pedantic 
...
LD          := gcc
LD_FLAGS    := -Wl,-Map=main.map -Wl,-wrap,main -Wl,-cref -ggdb3 
LD_LIBS     := -lm -lpthread 
...
${OUTDIR}/main: ${OUTDIR}/main.c.o ${OUTDIR}/heap.c.o ${OUTDIR}/unit_helper_v2.c.o ${OUTDIR}/unit_test_v2.c.o ${OUTDIR}/rdebug.c.o ${OUTDIR}/memmanager.c.o 
	@echo "Konsolidacja..."
	@${LD} ${LD_FLAGS} ${OUTDIR}/main.c.o ${OUTDIR}/heap.c.o ${OUTDIR}/unit_helper_v2.c.o ${OUTDIR}/unit_test_v2.c.o ${OUTDIR}/rdebug.c.o ${OUTDIR}/memmanager.c.o  -o ${OUTDIR}/main ${LD_LIBS}
